...
void mt65xx_eint_registration_threaded(unsigned int eint_num, unsigned int is_deb_en, unsigned int pol, void(EINT_FUNC_PTR)(void), void(threaed_isr)(void), unsigned int is_auto_umask)
{
...
/*Lenovo-sw chenglong1 add for threaded isr*/
#ifdef LENOVO_TP_OPTIMIZED
EXPORT_SYMBO(mt65xx_eint_registration_threaded);
#endif
/*Lenovo-sw add end*/
