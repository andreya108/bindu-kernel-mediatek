...
#define FGADC_LOGLEVEL_0 xlog_printk
#define FGADC_LOGLEVEL_1 if(Enable_FGADC_LOG>=1)xlog_printk
#define FGADC_LOGLEVEL_2 if(Enable_FGADC_LOG>=2)xlog_printk
#define FGADC_LOGLEVEL_3 if(Enable_FGADC_LOG>=3)xlog_printk
#define FGADC_KLOGLEVEL_0 printk
#define FGADC_KLOGLEVEL_1 if(Enable_FGADC_LOG>=1)printk
#define FGADC_KLOGLEVEL_2 if(Enable_FGADC_LOG>=2)printk
#define FGADC_KLOGLEVEL_3 if(Enable_FGADC_LOG>=3)printk
...
/*lenovo-sw weiweij added 20130315 end*/
...
void get_hw_chip_diff_trim_value(void)
{
    ...
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[Chip_Trim] Reg[0x%x]=0x%x, Reg[0x%x]=0x%x, chip_diff_trim_value_4_0=%d\n",
        0x01C4, upmu_get_reg_value(0x01C4), 0x01C6, upmu_get_reg_value(0x01C6), chip_diff_trim_value_4_0);

    #else
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[Chip_Trim] need check reg number\n");
    #endif

    switch(chip_diff_trim_value_4_0){
        case 0:
            chip_diff_trim_value = 1000;
            FGADC_KLOGLEVEL_0("chip_diff_trim_value = 1000; \n");
            break;
        ...
        default:
            FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[Chip_Trim] Invalid value(%d)\n", chip_diff_trim_value_4_0);
            break;
    }

    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[Chip_Trim] %d,%d\n",
...
kal_int32 use_chip_trim_value(kal_int32 not_trim_val)
{
    ...
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[use_chip_trim_value] %d -> %d\n", not_trim_val, ret_val);
    }
...
void FGADC_dump_register(void)
{
    ...
    for(i=reg_num ; i<=FGADC_CON19 ; i+=2)
    {
        ...
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "Reg[0x%x]=0x%x \r\n", i, reg_val);
    }
}
...
kal_uint32 fg_get_data_ready_status(void)
{
    ...
    if (Enable_FGADC_LOG == 1) {
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fg_get_data_ready_status] Reg[0x%x]=0x%x\r\n", FGADC_CON0, temp_val);
    }
...
kal_uint32 fg_get_sw_clear_status(void)
{
    ...
    if (Enable_FGADC_LOG == 1) {
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fg_get_sw_clear_status] Reg[0x%x]=0x%x\r\n", FGADC_CON0, temp_val);
    }
...
void dump_nter(void)
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[dump_nter] upmu_get_fg_nter_29_16 = 0x%x\r\n",
        upmu_get_fg_nter_29_16());
    FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[dump_nter] upmu_get_fg_nter_15_00 = 0x%x\r\n",
        upmu_get_fg_nter_15_00());
}

void dump_car(void)
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[dump_car] upmu_get_fg_car_35_32 = 0x%x\r\n",
        upmu_get_fg_car_35_32());
    FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[dump_car] upmu_get_fg_car_31_16 = 0x%x\r\n",
        upmu_get_fg_car_31_16());
    FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[dump_car] upmu_get_fg_car_15_00 = 0x%x\r\n",
...
//Read HW Raw Data
    ...
    while ( fg_get_data_ready_status() == 0 )
    {
        ...
        {
            if (Enable_FGADC_LOG == 1){
                FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[fgauge_read_columb] fg_get_data_ready_status timeout 1 !\r\n");
            }
            break;
        }
    }
    ...
    if (Enable_FGADC_LOG == 1) {
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] fgauge_read_columb : FG_CAR = 0x%x\r\n", uvalue32_CAR);
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] fgauge_read_columb : uvalue32_CAR_MSB = 0x%x\r\n", uvalue32_CAR_MSB);
    }
    //(5)    (Read other data)
    //(6)    Clear status to 0
    ...
    while ( fg_get_data_ready_status() != 0 )
    {
        ...
        {
            if (Enable_FGADC_LOG == 1){
                FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[fgauge_read_columb] fg_get_data_ready_status timeout 2 !\r\n");
            }
            break;
        }
    }
...
//calculate the real world data
    ...
    if (Enable_FGADC_LOG == 1) {
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] fgauge_read_columb : dvalue_CAR = %d\r\n", dvalue_CAR);
    }

    #if (OSR_SELECT_7 == 1)
        dvalue_CAR = dvalue_CAR * 8;
        if (Enable_FGADC_LOG == 1) {
            FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] fgauge_read_columb : dvalue_CAR update to %d\r\n", dvalue_CAR);
        }
    #endif
...
//Auto adjust value
    ...
    {
        if (Enable_FGADC_LOG == 1) {
            FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] Auto adjust value deu to the Rfg is %d\n Ori CAR=%d, ", R_FG_VALUE, dvalue_CAR);
        }
        dvalue_CAR = (dvalue_CAR*20)/R_FG_VALUE;
        if (Enable_FGADC_LOG == 1) {
            FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "new CAR=%d\n", dvalue_CAR);
        }
    }
    ...
    if (Enable_FGADC_LOG == 1) {
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] fgauge_read_columb : final dvalue_CAR = %d\r\n", dvalue_CAR);
    }
...
//Read HW Raw Data
    ...
    while ( fg_get_data_ready_status() == 0 )
    {
        ...
        {
            if (Enable_FGADC_LOG == 1){
                FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[fgauge_read_current] fg_get_data_ready_status timeout 1 !\r\n");
            }
            break;
        }
    }
    ...
    if (Enable_FGADC_LOG == 1) {
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] fgauge_read_current : FG_CURRENT = %x\r\n", uvalue16);
    }
    //(5)    (Read other data)
    //(6)    Clear status to 0
    ret=pmic_config_interface(FGADC_CON0, 0x0800, 0xFF00, 0x0);
    ...
    while ( fg_get_data_ready_status() != 0 )
    {
        ...
        {
            if (Enable_FGADC_LOG == 1){
                FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[fgauge_read_current] fg_get_data_ready_status timeout 2 !\r\n");
            }
            break;
        }
    }
...
//calculate the real world data
    ...
    if (Enable_FGADC_LOG == 1)
    {
        ...
        {
            FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] fgauge_read_current : current(charging) = %d mA\r\n", dvalue);
        }
        else
        {
            FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] fgauge_read_current : current(discharging) = %d mA\r\n", dvalue);
        }
    }
...
// Auto adjust value
    if(R_FG_VALUE != 20)
    {
        ...
        if (Enable_FGADC_LOG == 1) {
            FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "new current=%d\n", dvalue);
        }
    }
...
// current compensate
    ...
    if (Enable_FGADC_LOG == 1) {
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "ori current=%d\n", dvalue);
    }
    ...
    if (Enable_FGADC_LOG == 1) {
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "final current=%d (ratio=%d)\n", dvalue, CAR_TUNE_VALUE);
    }
...
kal_int32 fgauge_compensate_battery_voltage(kal_int32 ori_voltage)
{
    ...
    //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[CompensateVoltage] Ori_voltage:%d, compensate_value:%d, gFG_resistance_bat:%d, gFG_current:%d\r\n",
...
kal_int32 fgauge_compensate_battery_voltage_recursion(kal_int32 ori_voltage, kal_int32 recursion_time)
{
    ...
    for(i=0 ; i < recursion_time ; i++)
    {
        ...
        if (Enable_FGADC_LOG == 1)
        {
            FGADC_LOGLEVEL_0(ANDROID_LOG_VERBOSE, "Power/Battery", "[fgauge_compensate_battery_voltage_recursion] %d,%d,%d,%d\r\n",
    ...
    if (Enable_FGADC_LOG == 1)
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_compensate_battery_voltage_recursion] %d,%d,%d,%d\r\n",
            temp_voltage_1, temp_voltage_2, gFG_resistance_bat, ret_compensate_value);
    }
...
void fgauge_read_avg_I_V(void)
{
    ...
    for(i=0;i<14;i++)
    {
        ...
        cur_sum += gFG_current;
        //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_avg_I_V] #%d voltage[%d], current[%d]\r\n", i, vol[i], gFG_current);
    }
    ...
    for(i=2;i<12;i++)
    {
        if (Enable_FGADC_LOG == 1)
        {
            //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_avg_I_V] vol[%d] = %d\r\n", i, vol[i]);
        }
        vol_sum += vol[i];
    }
...
//    if (Enable_FGADC_LOG == 1)
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[fgauge_read_avg_I_V] AVG voltage[%d], current[%d]\r\n", gFG_voltage, gFG_current);
    }
}
...
kal_int32 fgauge_find_voltage_by_capacity(BATTERY_PROFILE_STRUC_P profile, kal_int32 bat_capacity)
{
    ...
    if (profile_p == NULL)
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_WARN, "Power/Battery", "[fgauge_read_v_by_capacity] fgauge get ZCV profile : fail !\r\n");
        return 3700;
    }
    ...
    for (i = 0; i < saddles - 1; i++)
    {
        if ((bat_capacity >= (profile_p+i)->percentage) && (bat_capacity <= (profile_p+i+1)->percentage))
        {
            ...
            FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_v_by_capacity] ret_volt=%d\r\n", ret_volt);
            FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_v_by_capacity] (profile_p+i)->percentag=%d\r\n", (profile_p+i)->percentage);
            FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_v_by_capacity] ((profile_p+i+1)->percentage)=%d\r\n", ((profile_p+i+1)->percentage));
            FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_v_by_capacity] ((profile_p+i)->voltage)=%d\r\n", ((profile_p+i)->voltage));
            FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_v_by_capacity] ((profile_p+i+1)->voltage) =%d\r\n", ((profile_p+i+1)->voltage));
...
void fgauge_construct_battery_profile(kal_int32 temperature, BATTERY_PROFILE_STRUC_P temp_profile_p)
{
    ...
    for (i = 0; i < saddles ; i++)
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "<DOD,Voltage> at %d = <%d,%d>\r\n",
...
void fgauge_construct_r_table_profile(kal_int32 temperature, R_PROFILE_STRUC_P temp_profile_p)
{
    ...
    for (i = 0; i < saddles ; i++)
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "<Rbat,VBAT> at %d = <%d,%d>\r\n",
...
/* R-Table (First Time) */
    ...
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_WARN, "Power/Battery", "[FGADC] fgauge_get_profile_r_table : create table fail !\r\n");
    }
    ...
    if (profile_p == NULL)
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_WARN, "Power/Battery", "[FGADC] fgauge_get_profile : create table fail !\r\n");
        return 100;
    }
    ...
    if (bOcv == KAL_FALSE)
    {
        ...
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC] compensate_battery_voltage, voltage=%d\r\n", voltage);
    }
    ...
    for (i = 0; i < saddles - 1; i++)
    {
        //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "Try <%d,%d> on %d\r\n", (profile_p+i)->voltage, (profile_p+i)->percentage, voltage);
        ...
        if ((voltage <= (profile_p+i)->voltage) && (voltage >= (profile_p+i+1)->voltage))
        {
            ...
            //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "DOD=%d\r\n", dod0);
    ...
    for (i = 0; i < saddles ; i++)
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "<Voltage,DOD> at %d = <%d,%d>\r\n",
...
void fg_qmax_update_for_aging(void)
{
    kal_int32 gFG_BATT_CAPACITY_TEMP =  gFG_BATT_CAPACITY_aging ;
    ...
    if(g_HW_Charging_Done == 1) // charging full
    {
        if(gFG_DOD0 > 85)
        {
            ...
            if(abs(gFG_BATT_CAPACITY_aging-gFG_BATT_CAPACITY_TEMP) > 500)
            {
                FGADC_KLOGLEVEL_0("fg_qmax_update_for_aging calibrate not valid with value =%d,%d\n",gFG_BATT_CAPACITY_aging,gFG_BATT_CAPACITY_TEMP );
                gFG_BATT_CAPACITY_aging = gFG_BATT_CAPACITY_TEMP ;
            }
			/*Lenovo-sw begin chenlj2 add 2011-06-02,add a enum for current */
    ...
    {
            FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[fg_qmax_update_for_aging] g_HW_Charging_Done=%d\r\n", g_HW_Charging_Done);
    }
}
...
kal_int32 fgauge_update_dod(void)
{
    ...
    {
        gFG_DOD0=100;
            FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_update_dod] gFG_DOD0 set to 100, gFG_columb=%d\r\n",
                gFG_columb);
    }
    else if(gFG_DOD0 < 0)
    {
        gFG_DOD0=0;
            FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_update_dod] gFG_DOD0 set to 0, gFG_columb=%d\r\n",
                gFG_columb);
    }
    else
    {
    ...
    if(g_update_qmax_flag == 1)
    {
        ...
        FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_update_dod] gFG_BATT_CAPACITY=%d, gFG_BATT_CAPACITY_aging=%d, gFG_BATT_CAPACITY_init_high_current=%d\r\n",
    ...
    FG_dod_1 =  gFG_DOD0 - ((gFG_columb*100)/gFG_BATT_CAPACITY_aging);
        ...
        FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_update_dod] FG_dod_1=%d, adjust_coulomb_counter=%d, gFG_columb=%d, gFG_DOD0=%d, gFG_temp=%d, gFG_BATT_CAPACITY=%d\r\n",
            FG_dod_1, adjust_coulomb_counter, gFG_columb, gFG_DOD0, gFG_temp, gFG_BATT_CAPACITY);

    if(FG_dod_1 > 100)
    {
        FG_dod_1=100;
            FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_update_dod] FG_dod_1 set to 100, gFG_columb=%d\r\n",
                gFG_columb);
    }
    else if(FG_dod_1 < 0)
    {
        FG_dod_1=0;
            FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_update_dod] FG_dod_1 set to 0, gFG_columb=%d\r\n",
                gFG_columb);
    }
    else
    {
...
kal_int32 fgauge_read_capacity(kal_int32 type)
{
    ...
    //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_capacity] %d\r\n", dvalue);
    ...
    if(C_0mA > C_400mA)
    {
        ...
        FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_capacity] %d,%d,%d,%d,%d,D1=%d,D0=%d\r\n",
    ...
    dvalue = ( (dvalue_new * gFG_BATT_CAPACITY_init_high_current * 100) / gFG_BATT_CAPACITY_aging ) / 100;
        FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_capacity] dvalue=%d, dvalue_new=%d, gFG_BATT_CAPACITY_init_high_current=%d, gFG_BATT_CAPACITY_aging=%d\r\n",
    ...
    {
        dvalue=1;
            FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_capacity] dvalue<=1 and set dvalue=1 !!\r\n");
    }
...
kal_int32 fgauge_read_capacity_by_v(void)
{
    ...
    if (profile_p == NULL)
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_WARN, "Power/Battery", "[FGADC] fgauge get ZCV profile : fail !\r\n");
        return 100;
    }
    ...
    {
        //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_capacity_by_v] 100:%d,%d\r\n", gFG_voltage, (profile_p+0)->voltage);
        return 100; // battery capacity, not dod
    }
    if (gFG_voltage < (profile_p+saddles-1)->voltage)
    {
        //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_capacity_by_v] 0:%d,%d\r\n", gFG_voltage, (profile_p+saddles-1)->voltage);
    ...
    for (i = 0; i < saddles - 1; i++)
    {
        ...
        //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_capacity_by_v] gFG_voltage=%d\r\n", gFG_voltage);
        //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_capacity_by_v] (profile_p+i)->percentag=%d\r\n", (profile_p+i)->percentage);
        //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_capacity_by_v] ((profile_p+i+1)->percentage)=%d\r\n", ((profile_p+i+1)->percentage));
        //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_capacity_by_v] ((profile_p+i)->voltage)=%d\r\n", ((profile_p+i)->voltage));
        //FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_read_capacity_by_v] ((profile_p+i+1)->voltage) =%d\r\n", ((profile_p+i+1)->voltage));
    }
...
kal_int32 fgauge_read_r_bat_by_v(kal_int32 voltage)
{
    ...
    if (profile_p == NULL)
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_WARN, "Power/Battery", "[FGADC] fgauge get R-Table profile : fail !\r\n");
...
kal_int32 fgauge_read_d_by_v(kal_int32 volt_bat)
{
    ...
    if (profile_p == NULL)
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] fgauge get ZCV profile : fail !\r\n");
        return 100;
    }
...
kal_int32 mtk_imp_tracking(kal_int32 ori_voltage, kal_int32 ori_current, kal_int32 recursion_time)
{
    ...
    for(i=0 ; i < recursion_time ; i++)
    {
        ...
        temp_voltage_2 = temp_voltage_1 + ret_compensate_value;
            ...
            FGADC_LOGLEVEL_1(ANDROID_LOG_INFO, "Power/FGOAM", "[mtk_imp_tracking] temp_voltage_2=%d,temp_voltage_1=%d,ret_compensate_value=%d,gFG_resistance_bat=%d\n",
...
void oam_init(void)
{
    ...
    if(oam_init_i == 0)
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/FGOAM", "[oam_init] oam_v_ocv_1,oam_v_ocv_2,oam_r_1,oam_r_2,oam_d0,oam_i_ori\n");
        oam_init_i=1;
    }

    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/FGOAM", "[oam_init] %d,%d,%d,%d,%d,%d\n",
...
//    vol_bat = get_bat_sense_volt(15);
    ...
    else
    {
        switch(get_charger_type()){
            ...
            case 4:    d5_count_time_rate = (((gFG_BATT_CAPACITY_aging*60*60/100/(650-50))*10)+5)/10;
                       break;
            default:
                FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[get_charger_type] Invalid value\n");
                break;
        }
    ...
    else
    {
        ...
        FGADC_LOGLEVEL_1(ANDROID_LOG_INFO, "Power/FGOAM", "[oam_run] %d,%d,%d,%d,%d,%d,%d\n",
            d5_count, d5_count_time, oam_d_3_pre, oam_d_3, oam_d_4_pre, oam_d_4, oam_d_5);

    if(oam_run_i == 0)
    {
            FGADC_LOGLEVEL_1(ANDROID_LOG_INFO, "Power/FGOAM", "[oam_run] oam_i_1,oam_i_2,oam_car_1,oam_car_2,oam_d_1,oam_d_2,oam_v_ocv_1,oam_d_3,oam_r_1,oam_v_ocv_2,oam_r_2,vol_bat,vol_bat_hw_ocv,d_hw_ocv\n");
        oam_run_i=1;
    }

        FGADC_LOGLEVEL_1(ANDROID_LOG_INFO, "Power/FGOAM", "[oam_run] %d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
        ...
        FGADC_LOGLEVEL_1(ANDROID_LOG_INFO, "Power/FGOAM", "[oam_total] %d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
        ...
        FGADC_LOGLEVEL_2(ANDROID_LOG_INFO, "Power/FGOAM", "[oam_total_s] %d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n",
            gFG_capacity_by_c,        // 1
            gFG_capacity_by_v,        // 2
        ...
        FGADC_LOGLEVEL_1(ANDROID_LOG_INFO, "Power/FGOAM", "[oam_total_s_err] %d,%d,%d,%d,%d,%d,%d\n",
...
//1.1 Average FG_voltage
    ...
    if(gFG_booting_counter_I_FLAG != 0)
    {
        ...
        if(gFG_vbat_offset <= MinErrorOffset)
        {
            ...
            if (Enable_FGADC_LOG == 1)
            {
                FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[FG_BUFFER] ");
                for (i=0; i<FG_VBAT_AVERAGE_SIZE; i++) {
                    FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "%d,", FGvbatVoltageBuffer[i]);
                }
                FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "\r\n");
            }
        }
        else
        {
                FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[FG] Over MinErrorOffset:V=%d,Avg_V=%d, ", gFG_voltage, gFG_voltage_AVG);

            gFG_voltage = gFG_voltage_AVG;

                FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "Avg_V need write back to V : V=%d,Avg_V=%d.\r\n", gFG_voltage, gFG_voltage_AVG);
        }
    }
    /**************** Averaging : END ****************/
...
/*lenovo-sw weiweij added 20130314*/
#if 1
...
#endif
/*lenovo-sw weiweij added 20130314 end*/
...
//4. update DOD0 after booting Xs
    if(gFG_booting_counter_I_FLAG == 1)
    {
        ...
        {
/*lenovo-sw weiweij modified for add hw soc*/
#if 1
/*lenovo-sw weiweij modified for add hw soc end*/
            //use get_hw_ocv-----------------------------------------------------------------
            gFG_voltage = get_hw_ocv();
            gFG_capacity_by_v = fgauge_read_capacity_by_v();
            FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] get_hw_ocv=%d, SOC=%d, sw_soc=%d\n",
...
/*lenovo-sw weiweij added 20130314*/
			...
			{
				FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] upmu_is_chr_det = true, use gFG_capacity_by_v_init(%d)\n", gFG_capacity_by_v_init);
...
/*lenovo-sw weiweij added for hw_ocv check error in watch dog reboot mode*/
		FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "ww_debug g_boot_reason(%d)\n", g_boot_reason);
		if(g_boot_reason==BR_WDT_BY_PASS_PWK)
		{
			FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "ww_debug g_boot_reason(%d), use sw soc (%d)\n", g_boot_reason, gFG_capacity_by_v_init);
			gFG_capacity_by_v = gFG_capacity_by_v_init;
		}
/*lenovo-sw weiweij added for hw_ocv check error in watch dog reboot mode end*/
			...
			if(g_rtc_fg_soc >= gFG_capacity_by_v)
			{
				...
				FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] [1] g_rtc_fg_soc=%d, gFG_capacity_by_v=%d\n",
			...
			else
			{
				...
				FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] [2] g_rtc_fg_soc=%d, gFG_capacity_by_v=%d\n",
					g_rtc_fg_soc, gFG_capacity_by_v);
			}
            //-------------------------------------------------------------------------------
        ...
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] update DOD0 after booting %d s\r\n", (MAX_BOOTING_TIME_FGCURRENT));
        ...
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] gFG_15_vlot = %dmV\r\n", gFG_15_vlot);
        #else
        ...
        {
            FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] gFG_15_vlot(%d) over range, reset to 3700\r\n", gFG_15_vlot);
            gFG_15_vlot = 3700;
        }
        #endif
...
/*lenovo-sw weiweij modified 20130427 end*/
        {
            FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "gFG_current_auto_detect_R_fg_total=0, need double check [2]\n");
...
/*lenovo-sw weiweij added 20130427*/
		...
		if(gFG_current_auto_detect_R_fg_total <= CURRENT_DETECT_R_FG*gFG_current_auto_detect_R_fg_count)
		{
			...
			FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "gFG_current_auto_detect_R_fg_total=0, need double check [3]\n");
		...
		if(gFG_current_auto_detect_R_fg_total <= CURRENT_DETECT_R_FG*gFG_current_auto_detect_R_fg_count)
		{
			...
			FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "gFG_current_auto_detect_R_fg_total=0, need double check [4]\n");
		...
		if(gFG_current_auto_detect_R_fg_total <= CURRENT_DETECT_R_FG*gFG_current_auto_detect_R_fg_count)
		{
			...
			FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "gFG_current_auto_detect_R_fg_total=0, need double check [5]\n");
...
/*lenovo-sw weiweij added 20130427 end*/
        ...
        if(gFG_current_auto_detect_R_fg_result <= CURRENT_DETECT_R_FG)
        {
            ...
            FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] Detect NO Rfg, use AUXADC report. (%d=%d/%d)(%d)\r\n",
        ...
        else
        {
            if(gForceADCsolution == 0)
            {
                ...
                FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] Detect Rfg, use FG report. (%d=%d/%d)(%d)\r\n",
                gFG_current_auto_detect_R_fg_result, gFG_current_auto_detect_R_fg_total,
                gFG_current_auto_detect_R_fg_count, gForceADCsolution);
        }
            else
            {
                FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] Detect Rfg, but use AUXADC report. due to gForceADCsolution=%d \r\n",
                    gForceADCsolution);
            }
        }
    }
...
kal_int32 fgauge_get_Q_max(kal_int16 temperature)
{
    ...
    (
        ...
        FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_get_Q_max] Q_max = %d\r\n", ret_Q_max);
...
kal_int32 fgauge_get_Q_max_high_current(kal_int16 temperature)
{
    ...
    (
        ...
        FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[fgauge_get_Q_max_high_current] Q_max = %d\r\n", ret_Q_max);
...
//FGADC clock is 32768Hz from RTC
    ...
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "******** [fgauge_initialization] reset HW FG!\n" );
...
//    gFG_voltage = get_hw_ocv();
    ...
    if(g_ocv_lookup_done == 0)
    {
        ...
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "g_ocv_loopup_done is 0, do fgauge_read_capacity(0)\n" );
    }
    else
    {
    ...
    FGADC_LOGLEVEL_0(ANDROID_LOG_DEBUG, "Power/Battery", "******** [fgauge_initialization] Done!\n" );
...
void FGADC_Reset_SW_Parameter(void)
{
...
#if 0
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] FGADC_Reset_SW_Parameter : Todo \r\n");
#else
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] FGADC_Reset_SW_Parameter : Start \r\n");
    ...
    while(val_car != 0x0)
    {
        ...
        val_car = gFG_columb;
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "#");
    }
    gFG_columb = 0;
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] FGADC_Reset_SW_Parameter : Done \r\n");

    if(g_Calibration_FG==1)
    {
        gFG_DOD0 = 0;
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] FG Calibration DOD0=%d and DOD1=%d \r\n", gFG_DOD0, gFG_DOD1);
    }
    else
    {
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] Update DOD0(%d) by %d \r\n", gFG_DOD0, gFG_DOD1);
        gFG_DOD0 = gFG_DOD1;
    }
#endif
...
kal_int32 get_dynamic_period(int first_use, int first_wakeup_time, int battery_capacity_level)
{
    ...
    else
    {
        ...
        if(g_car_sleep > g_car_wakeup)
        {
            ...
            FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[get_dynamic_period] reset g_car_sleep\r\n");
        }
        ...
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[get_dynamic_period] g_car_instant=%d, g_car_wakeup=%d, g_car_sleep=%d, I_sleep=%d, gFG_BATT_CAPACITY=%d, g_last_time=%d, new_time=%d\r\n",
...
#else
    ret_val = first_wakeup_time;
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[get_dynamic_period] ret_val = %d\n", first_wakeup_time);
#endif
...
void fg_voltage_mode(void)
{
    ...
    FGADC_LOGLEVEL_1(ANDROID_LOG_DEBUG, "Power/Battery", "[FGADC_VoltageMothod] gFG_capacity_by_v=%d,gfg_percent_check_point=%d\r\n",
...
void FGADC_thread_kthread(void)
{
    ...
    else
    {
        ...
        FGADC_LOGLEVEL_1(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] %d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\r\n",
    ...
    if(gFG_booting_counter_I >= MAX_BOOTING_TIME_FGCURRENT)
    {
        ...
        if(gFG_current_auto_detect_R_fg_total == 0)
        {
            FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "gFG_current_auto_detect_R_fg_total=0, need double check\n");
                        ...
                        unsigned long len, void *data )
{
    if (copy_from_user( &proc_fgadc_data, buff, len )) {
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "fgadc_log_write error.\n");
        return -EFAULT;
    }

    if (proc_fgadc_data[0] == '1') {
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "enable FGADC driver log system\n");
        Enable_FGADC_LOG = 1;
    } else if (proc_fgadc_data[0] == '2') {
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "enable FGADC driver log system:2\n");
        Enable_FGADC_LOG = 2;
    } else {
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "Disable FGADC driver log system\n");
        Enable_FGADC_LOG = 0;
    }
...
int init_proc_log_fg(void)
{
    ...
    if (proc_entry_fgadc == NULL) {
        ret = -ENOMEM;
          FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "init_proc_log_fg: Couldn't create proc entry\n");
    } else {
        proc_entry_fgadc->write_proc = fgadc_log_write;
        //proc_entry->owner = THIS_MODULE;
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "init_proc_log_fg loaded.\n");
    }
...
static ssize_t show_FG_Current(struct device *dev,struct device_attribute *attr, char *buf)
{
    ...
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] %d\r\n", gFG_current_inout_battery);
    //-----------------------------------------------
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] gFG_current_inout_battery : %d\n", gFG_current_inout_battery);
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] g_fg_dbg_bat_volt : %d\n", g_fg_dbg_bat_volt);
    return sprintf(buf, "%d\n", g_fg_dbg_bat_volt);
}
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] g_fg_dbg_bat_current : %d\n", g_fg_dbg_bat_current);
    return sprintf(buf, "%d\n", g_fg_dbg_bat_current);
}
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] g_fg_dbg_bat_zcv : %d\n", g_fg_dbg_bat_zcv);
    return sprintf(buf, "%d\n", g_fg_dbg_bat_zcv);
}
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] g_fg_dbg_bat_temp : %d\n", g_fg_dbg_bat_temp);
    return sprintf(buf, "%d\n", g_fg_dbg_bat_temp);
}
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] g_fg_dbg_bat_r : %d\n", g_fg_dbg_bat_r);
    return sprintf(buf, "%d\n", g_fg_dbg_bat_r);
}
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] g_fg_dbg_bat_car : %d\n", g_fg_dbg_bat_car);
    return sprintf(buf, "%d\n", g_fg_dbg_bat_car);
}
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] g_fg_dbg_bat_qmax : %d\n", g_fg_dbg_bat_qmax);
    return sprintf(buf, "%d\n", g_fg_dbg_bat_qmax);
}
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] g_fg_dbg_d0 : %d\n", g_fg_dbg_d0);
    return sprintf(buf, "%d\n", g_fg_dbg_d0);
}
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] g_fg_dbg_d1 : %d\n", g_fg_dbg_d1);
    return sprintf(buf, "%d\n", g_fg_dbg_d1);
}
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] g_fg_dbg_percentage : %d\n", g_fg_dbg_percentage);
    return sprintf(buf, "%d\n", g_fg_dbg_percentage);
}
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] g_fg_dbg_percentage_fg : %d\n", g_fg_dbg_percentage_fg);
    return sprintf(buf, "%d\n", g_fg_dbg_percentage_fg);
}
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FG] g_fg_dbg_percentage_voltmode : %d\n", g_fg_dbg_percentage_voltmode);
    return sprintf(buf, "%d\n", g_fg_dbg_percentage_voltmode);
}
...
static int mt6320_fgadc_probe(struct platform_device *dev)
{
    ...
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] INIT : EVB \n");
#else
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] MT6320 FGADC driver probe!! \n" );
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] MT6320 FGADC driver remove!! \n" );
...
{
    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "[FGADC] MT6320 FGADC driver shutdown!! \n" );
}
...
#if defined(CONFIG_POWER_EXT)
    FGADC_LOGLEVEL_0(ANDROID_LOG_VERBOSE, "Power/Battery", "[FGADC_suspend] EVB !!\n");
#else
    FGADC_LOGLEVEL_0(ANDROID_LOG_VERBOSE, "Power/Battery", "[FGADC_suspend] TODO !!\n");
#endif
...
{
#if defined(CONFIG_POWER_EXT)
    FGADC_LOGLEVEL_0(ANDROID_LOG_VERBOSE, "Power/Battery", "[FGADC_RESUME] EVB !!\n");
#else
    FGADC_LOGLEVEL_0(ANDROID_LOG_VERBOSE, "Power/Battery", "[FGADC_RESUME] !!\n");
#endif
...
static int __init mt6320_fgadc_init(void)
{
    ...
    if (ret) {
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "****[mt6320_fgadc_driver] Unable to device register(%d)\n", ret);
        return ret;
    }

    ret = platform_driver_register(&mt6320_fgadc_driver);
    if (ret) {
        FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "****[mt6320_fgadc_driver] Unable to register driver (%d)\n", ret);
        return ret;
    }

    FGADC_LOGLEVEL_0(ANDROID_LOG_INFO, "Power/Battery", "****[mt6320_fgadc_driver] Initialization : DONE \n");
