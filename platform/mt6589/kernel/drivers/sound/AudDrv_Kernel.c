...
/* lenovo-sw zhouwl, 2013-04-16, add for switch ref-mic@HD soundrecorder */
...
/* lenovo-sw zhouwl, 2013-04-16, add for switch ref-mic@HD soundrecorder */
        ...
        case SET_EARPIECE_ON:
            ...
            mutex_lock(&gamp_mutex);
/* lenovo-sw zhouwl, 2014-03-12, confirm select rec */
#if defined(LENOVO_NXP_SMARTPA_SUPPORT)
            mt_set_gpio_mode(GPIO_ANALOG_SWITCH_PIN, GPIO_MODE_00);
            mt_set_gpio_dir(GPIO_ANALOG_SWITCH_PIN, GPIO_DIR_OUT);
            mt_set_gpio_out(GPIO_ANALOG_SWITCH_PIN, GPIO_OUT_ONE);
#endif
/* lenovo-sw zhouwl, 2014-03-12, confirm select rec */
...
/* lenovo-sw zhouwl, 2013-04-16, add for switch ref-mic@HD soundrecorder */
#if defined(LENOVO_THREE_MIC_SUPPORT)
	case SET_HDREC_REFMIC_ON:
            PRINTK_AUDDRV("[zhouwl]AudDrv SET_HD_REFMIC_ON arg:%lu, low, mic2 \n",arg);
	     ...
	     mt_set_gpio_out(GPIO_MIC3_SWITCH_PIN,0); //gpio116, output, low, mic2
            break;
	case SET_HDREC_REFMIC_OFF:
            PRINTK_AUDDRV("[zhouwl]AudDrv SET_HD_REFMIC_OFF arg:%lu, high, mic3 \n",arg);
	     mt_set_gpio_mode(GPIO_MIC3_SWITCH_PIN,0);  
	     mt_set_gpio_pull_enable(GPIO_MIC3_SWITCH_PIN,1);
	     mt_set_gpio_dir(GPIO_MIC3_SWITCH_PIN,1);
