...
#lenovo sw chenlj2 modify for bmc056
...
CUSTOM_KERNEL_ALSPS = APDS9930_snoopytd
...
#lenovo-sw chenjian2 modify on 20140128
...
#lenovo-sw wangsq2 modify for single sim, 20140214
...
#lenovo-sw wangsq2 modify, turn off data by default
...
#lenovo-sw wangsq2 20140128 remove DRM
...
#lenovo-sw zhouwl,2014-01-26,enable dual mic
...
#Lenovo-sw linyf modify 2014-3-11 10:28 begin , modify for snoopytd.
#MTK_ENABLE_MD1=yes
MTK_ENABLE_MD1=no
#MTK_ENABLE_MD2=no
MTK_ENABLE_MD2=yes
#Lenovo-sw linyf modify 2014-3-11 10:28 end.
MTK_ENABLE_MD5=no
...
#Begin Lenovo-sw huangxuan closed, 2012-11-28
# use this feature option to enable/disable File Manager App
MTK_FILEMANAGER_APP = no
#End Lenovo-sw huangxuan closed, 2012-11-28
...
#lenovo-sw wangsq2 modify for disable 3G switch begin
MTK_GEMINI_SMART_3G_SWITCH = 0
#lenovo-sw wangsq2 modify end
...
#Begin, lenovo-sw wangxf14 modify for no external sdcard
...
#End, lenovo-sw wangxf14 modify for no external sdcard
...
#lenovo-sw wangsq2 20130123 remove sms reg begin
# if MTK_SMSREG_APP=yes,build SmsReg.apk
MTK_SMSREG_APP = no
#lenovo-sw wangsq2 20130123 remove sms reg end
...
# MTK_FLIGHT_MODE_POWER_OFF_MD is used to control if modem is powered off when entering flight mode MTK_TELEPHONY_MODE is used for specify current telephony mode MTK_FIRST_MD is used to specify the high priority modem
#Lenovo-sw linyf modify 2014-3-11 10:28 , modify for snoopytd.
#MTK_TELEPHONY_MODE=1
MTK_TELEPHONY_MODE=4
...
# Begin, lenovo-sw wangxf14 modify for no extern sdcard
RESOURCE_OVERLAY_SUPPORT=generic sd_inner_ums
# End, lenovo-sw wangxf14 modify for no extern sdcard
...
CUSTOM_MODEM = mt6589_md2_snoopytd
...
LENOVO_PRODUCT_DEVICE = S968t
#Lenovo-sw yexh1 LENOVO_USB_STANDARD end
#modified by lenovo-xm.chenyb1 add
LENOVO_STD_LINECTL_EARPHONE = yes
#modified by lenovo-xm.chenyb1 end
#lenovo chenyb1 add for cpufreq limit when screen off 
LENOVO_CPUFREQ_LIMIT = yes
#lenovo chenyb1 add for cpufreq limit when screen off end
#lenovo-sw jixu begin
LENOVO_LCD_BACKLIGHT_CONTROL_BY_LCM = yes
LENOVO_LP5560_SUPPORT = yes
#lenovo-sw jixu end
#lenovo-sw molg1 2014.01.23 add begin
BOSH_BMC056_SENSOR = yes
#lenovo-sw molg1 2014.01.23 add end
#lenovo-sw zhouwl,2014-01-26,add nxp pa begin
LENOVO_NXP_SMARTPA_SUPPORT = yes
#lenovo-sw zhouwl,2014-01-26,add nxp pa end
...
#lenovo-sw jixj 2013.6.12 add begin
LENOVO_RECOVERY_ONLINE = yes
#lenovo-sw jixj 2013.6.12 add end
#lenovo jixu add for backlight limit in bsp
...
#Begin lenovo-sw lixh10 add for control glove function. 2014-3-18 begin 
LENOVO_CTP_USB_PROTECT =yes
#Begin lenovo-sw lixh10 add for control glove function. 2014-3-18 end
