...
/*
	...
	const nvram_camera_para_struct GC0328_YUV_CAMERA_PARA_DEFAULT_VALUE={0};
	const nvram_camera_3a_struct GC0328_YUV_CAMERA_3A_NVRAM_DEFAULT_VALUE={0};
#else
//#include "camera_para.h"
//#include "camera_sensor_para_GC0328_YUV.h"
