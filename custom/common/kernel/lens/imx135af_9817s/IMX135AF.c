...
#define IMX135AF_write_cmos_lens(addr, para) iWriteReg((u16) addr , (u32) para , 1, IMX135AF_VCM_WRITE_ID)

kal_uint16 IMX135AF_read_cmos_lens(kal_uint32 addr)
{
kal_uint16 get_byte=0;
    iReadReg((u16) addr ,(u8*)&get_byte,IMX135AF_VCM_WRITE_ID);
    return get_byte;
}
...
static int s4IMX135AF_WriteReg(u16 a_u2Data)
{
  ...
  //  char puSendCmd[2] = {(char)(a_u2Data >> 4) , (char)(((a_u2Data & 0xF) << 4)+g_sr)};
    ...
    char puSendCmd1[2] = {(char)( 0x02), (char)(a_u2Data >> 8)};
    char puSendCmd2[2] = {(char)(0x03) , (char)(a_u2Data )};
    ...
    i4RetValue1 = i2c_master_send(g_pstIMX135AF_I2Cclient, puSendCmd1, 2);
    i4RetValue2 = i2c_master_send(g_pstIMX135AF_I2Cclient, puSendCmd2, 2);
	//(0x18, 0x02, 0xxx);///1
	//(0x18, 0x03, 0xxx);
...
static int IMX135AF_Open(struct inode * a_pstInode, struct file * a_pstFile)
{
    ...
    char puSendCmd[2] = {(char)( 0x01), (char)(0x39)};	
    int  i4RetValue = 0;
    spin_lock(&g_IMX135AF_SpinLock);
    ...
    spin_unlock(&g_IMX135AF_SpinLock);
	// Please wirte initial setting for DW9718S in herer
	//(0x18, 0x01, 0x39);
      //IMX135AF_write_cmos_lens(0x01,0x39);
    i4RetValue = i2c_master_send(g_pstIMX135AF_I2Cclient, puSendCmd, 2);
