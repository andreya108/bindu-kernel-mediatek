...
#ifndef DW9718
    i4RetValue = i2c_master_recv(g_pstDW9718AF_I2Cclient, pBuff , 2);

    if (i4RetValue < 0) 
    {
        DW9718AFDB("[DW9718AF] I2C read failed!! \n");
        return -1;
    }
...
static int s4DW9718AF_WriteReg(u16 a_u2Data)
{
    ...
    DW9718AFDB("[DW9718AF] g_sr %d, write %d \n", g_sr, a_u2Data);
	g_pstDW9718AF_I2Cclient->ext_flag |= I2C_A_FILTER_MSG;
    i4RetValue = i2c_master_send(g_pstDW9718AF_I2Cclient, puSendCmd, 2);
#else
