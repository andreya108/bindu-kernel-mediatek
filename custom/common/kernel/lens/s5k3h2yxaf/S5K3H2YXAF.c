...
#define S5K3H2YXAF_VCM_WRITE_ID           0x28
static struct i2c_board_info __initdata kd_lens_dev={ I2C_BOARD_INFO(S5K3H2YXAF_DRVNAME, S5K3H2YXAF_VCM_WRITE_ID)};
...
/* Kirby: } */
{
    ...
    */
    ...
    g_pstS5K3H2YXAF_I2Cclient->addr = 0x18;//revert here.
