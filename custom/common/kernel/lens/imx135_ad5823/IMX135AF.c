...
static struct i2c_board_info __initdata kd_lens_dev={ I2C_BOARD_INFO("IMX135AF", 0x1E)};
...
static int s4IMX135AF_ReadReg(unsigned short * a_pu2Result)
{
	...
	g_pstIMX135AF_I2Cclient->addr = 0x0C;

	char VCMMSB[1] = {(char)(0x04)};
	char VCMLSB[1] = {(char)(0x05)};
    //IMX135AFDB("[IMX135AF] s4IMX135AF_ReadReg \n");
	//g_pstIMX135AF_I2Cclient->addr = 0x18;
//Read MSB	
    i4RetValue = i2c_master_send(g_pstIMX135AF_I2Cclient, VCMMSB, 1);
    ...
    i4RetValue = i2c_master_recv(g_pstIMX135AF_I2Cclient, &pBuff[1] , 1);

    IMX135AFDB("[IMX135AF] s4IMX135AF_ReadReg VCMMSB: %d \n",pBuff[1]);
	//mt_set_gpio_out(97,0);
//Read LSB
	i4RetValue = i2c_master_send(g_pstIMX135AF_I2Cclient, VCMLSB, 1);
    ...
    i4RetValue = i2c_master_recv(g_pstIMX135AF_I2Cclient, &pBuff[0] , 1);
    IMX135AFDB("[IMX135AF] s4IMX135AF_ReadReg VCMMSB: %d \n",pBuff[1]);
    if (i4RetValue < 0) 
    {
...
static int s4IMX135AF_WriteReg(u16 a_u2Data)
{
	...
	g_pstIMX135AF_I2Cclient->addr = 0x0C;
    i4RetValue = i2c_master_send(g_pstIMX135AF_I2Cclient, VCMMSB, 2);
	i4RetValue = i2c_master_send(g_pstIMX135AF_I2Cclient, VCMLSB, 2);
...
static int AD5823_Mode_Init(int a)
{
	...
	IMX135AFDB("[IMX135AF] s4IMX135AF_mode_init :0x02\n");
	
	g_pstIMX135AF_I2Cclient->addr = 0x0C;
	
	i4RetValue = i2c_master_send(g_pstIMX135AF_I2Cclient, Mode, 2);
	i4RetValue = i2c_master_send(g_pstIMX135AF_I2Cclient, MoveTime, 2);
#if 1
	i4RetValue = i2c_master_send(g_pstIMX135AF_I2Cclient, VCMMSB, 2);
	i4RetValue = i2c_master_send(g_pstIMX135AF_I2Cclient, VCMLSB, 2);
#endif
