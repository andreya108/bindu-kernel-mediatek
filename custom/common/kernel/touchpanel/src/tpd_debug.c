...
/*Lenovo-sw chenglong1 add for debug*/
#ifdef LENOVO_TP_OPTIMIZED
int tpd_delay_debug = 0;
module_param(tpd_delay_debug, int, 00664);

int tpd_boost_cpu_cores = 4;
module_param(tpd_boost_cpu_cores, int, 00664);

int tpd_hold_cpu_ms = 2000;
module_param(tpd_hold_cpu_ms, int, 00664);

int tpd_vibrate_debug = 0;
module_param(tpd_vibrate_debug, int, 00664);

int tpd_filter_type = 0;
module_param(tpd_filter_type, int, 00664);

int tpd_thread_isr = 1;
module_param(tpd_thread_isr, int, 00644);
#endif
/*Lenovo-sw add end*/
