...
extern int tpd_delay_debug;
extern int tpd_vibrate_debug;
extern int tpd_filter_type;
extern int tpd_boost_cpu_cores;
extern int tpd_thread_isr;
extern int tpd_hold_cpu_ms;
#endif
/*Lenovo-sw add end*/
