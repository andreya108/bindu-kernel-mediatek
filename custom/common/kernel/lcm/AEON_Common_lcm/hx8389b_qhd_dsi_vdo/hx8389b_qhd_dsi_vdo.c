...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0xB1,19,{0x00,0x00,0x04,0xE8,0x50,0x10,0x11,0xb1,0xf1,0x3c,0x44,0x28,0x28,0x42,0x01,0x5A,0xF7,0x00,0xE6}},       

	{0xB2,7,{0x00,0x00,0x78,0x08,0x0b,0x3F,0x80}},	

	{0xb4,31,{0x80,0x08,0x00,0x32,0x10,0x06,0x30,0x13,0xd2,0x00,0x00,0x00,0x3f,0x0A,0x40,0x08,0x37,0x0A,0x40,0x14,0x46,0x50,0x0A,0x0a,0x40,0x0a,0x40,0x14,0x46,0x50,0x0A}},	

	{0xd5,48,{0x00,0x00,0x00,0x00,0x01,0x00,0x00,0x00,0xa0,0x10,0x88,0x88,0x88,0x01,0x08,0x48,0x81,0x85,0x28,0x68,0x83,0x87,0x05,0x88,0x48,0x88,0x88,0x88,0x88,0x88,0x88,0x88,0x10,0x78,0x38,0x86,0x82,0x58,0x10,0x84,0x80,0x84,0x80,0x58,0x88,0x88,0x88,0x88}},

	{0xe0,34,{0x05,0x1e,0x21,0x39,0x3F,0x3F,0x2f,0x4a,0x09,0x0e,0x0F,0x12,0x14,0x11,0x14,0x10,0x18,0x05,0x1e,0x21,0x39,0x3F,0x3F,0x2f,0x4a,0x09,0x0e,0x0F,0x12,0x14,0x11,0x14,0x10,0x18}},
	


	{0xCc,1,{0x02}},

	{0xB6,4,{0x00,0xA6,0x00,0xA6}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dsi.vertical_backporch   = 8;// 50 10
    params->dsi.vertical_frontporch  = 9;
    params->dsi.vertical_active_line     = FRAME_HEIGHT;

    params->dsi.horizontal_sync_active   = 50;// 200
...
static void lcm_init_register(void)
{
	...
	data_array[5] = 0x400A3708;//0x40013708;
	data_array[6] = 0x0A504614;//0x0B586718   	
	...
	data_array[9] =0x00181014;
	 ...
	 data_array[0] = 0x00023902;                          
        data_array[1] = 0x0000002CC;
        dsi_set_cmdq(&data_array, 2, 1);
        MDELAY(5);  

	  
	data_array[0] = 0x00053902;                          
       data_array[1] = 0x00B000B6;
	data_array[2] = 0x000000B0;
        dsi_set_cmdq(&data_array, 3, 1);
        MDELAY(5);  
