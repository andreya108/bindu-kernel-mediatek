...
static void init_lcm_registers(void)
{
    ...
    //AVDD ratio
    set_lcm_register(0xB600, 0x45);
    set_lcm_register(0xB601, 0x45);
    set_lcm_register(0xB602, 0x45);
    ...
    //AVEE ratio
    set_lcm_register(0xB700, 0x45);
    set_lcm_register(0xB701, 0x45);
    set_lcm_register(0xB702, 0x45);
    ...
    //VCL ratio
    set_lcm_register(0xB800, 0x35);
    set_lcm_register(0xB801, 0x35);
    set_lcm_register(0xB802, 0x35);
    ...
    //VGH ratio
    set_lcm_register(0xB900, 0x35);
    set_lcm_register(0xB901, 0x35);
    set_lcm_register(0xB902, 0x35);
    ...
    //VGLX ratio
    set_lcm_register(0xBA00, 0x34);
    set_lcm_register(0xBA01, 0x34);
    set_lcm_register(0xBA02, 0x34);
    ...
    //Gate EQ control
    set_lcm_register(0xB700, 0x74);
    set_lcm_register(0xB701, 0x74);
    ...
    set_lcm_register(0x3500, 0x01);    // TE on
...
static void lcm_get_params(LCM_PARAMS *params)
{
    ...
    params->dpi.hsync_pulse_width = 0xE;
    params->dpi.hsync_back_porch  = 0x7;
    params->dpi.hsync_front_porch = 0x7;
    params->dpi.vsync_pulse_width = 0x7;
    params->dpi.vsync_back_porch  = 0x7;
    params->dpi.vsync_front_porch = 0x7;
