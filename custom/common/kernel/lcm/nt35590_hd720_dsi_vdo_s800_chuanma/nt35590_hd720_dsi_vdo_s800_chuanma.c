...
#ifdef LCM_LINE_4
	{0xBA,1,{0x03}},//4LANES	0x03 4-lanes	0x01:2lane
#else
	{0xBA,1,{0x01}},//4LANES	0x03 4-lanes	0x01:2lane
#endif
//	{0xC2,1,{0x0B}},//Video mode with Ram
	{0xC2,1,{0x03}},//Video mode with Ram
	//{0xC2,1,{0x08}},//command mode with Ram
	...
	{0xC2,1,{0x08}},//
	{0xFF,1,{0x01}},//                                 
	{0x00,1,{0x3A}},//Set select panel application           
	{0x01,1,{0x33}},//Set Pump Freq                          
	{0x02,1,{0x53}},//                                       
//	{0x03,1,{0x55}},//                                       
//	{0x04,1,{0x55}},//                                       
...
//	{0x06,1,{0x22}},//Set AVDD/AVEE output level             
//	{0x08,1,{0x56}},//Set VGH level 2AVDD/VGL level 2VCL-AVDD
	{0x09,1,{0x85}},//Set VGL -8V                            
//	{0x0B,1,{0xCF}},//Set GVDDP=-4.7V                        
//	{0x0C,1,{0xCF}},//Set GVDDP=+4.7V                        
//	{0x0D,1,{0x2F}},//Set VCI1=3.05V                         
	{0x0E,1,{0x25}},//Set VGHO=10V  
	{0x0F,1,{0x0A}},//Set VGHO=10V   
    {0x0B,1,{0x97}},//Set VGHO=10V   
    {0x0C,1,{0x97}},//Set VGHO=10V  
	//{0x0E,1,{0x29}},
	{0x11,1,{0x86}},//Set VCOMDC3                            
	{0x12,1,{0x03}},//                                       
	{0x36,1,{0x7B}},//Enable gate EQ                         
	{0xB0,1,{0x80}},//NVT ENGINEER COMMAND                   
	{0xB1,1,{0x02}},//For Bonding too large , drop voltage   
	{0x71,1,{0x2C}},//                                       
	{0xFF,1,{0x05}},//                                       
//	{0x13,1,{0x02}},//                                       
//	{0x6A,1,{0x60}},//    
...
static unsigned int lcm_compare_id(void)
{
    ...
    #ifdef BUILD_LK
		 printf("### leanda chuanma1 lcd_id= %d \r\n",lcd_id);
    #else
		 printk("### leanda chuanma lcd_id= %d \r\n",lcd_id);
    #endif
//#ifdef BUILD_LK
...
LCM_DRIVER nt35590_hd720_dsi_vdo_s800_chuanma_lcm_drv = 
{
    .name			= "nt35590_hd720_dsi_vdo_s800_chuanma",
